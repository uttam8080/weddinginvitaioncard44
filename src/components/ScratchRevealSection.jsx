...
export const ScratchRevealSection = () => {
  return (
    <section id="scratch-reveal" className="py-24 px-4 bg-[#f7f3ea] relative overflow-hidden">
      <div className="max-w-5xl mx-auto text-center">
        ...
        <div className="mb-10">
          ...
          <h2 className="font-serif-display text-3xl sm:text-5xl text-[#3d3226] font-medium">
            {SCRATCH_REVEAL_DATA.heading || "Scratch To Reveal Our Details"}
          </h2>
          <FlourishDivider light={false} className="mt-2" />
        </div>
